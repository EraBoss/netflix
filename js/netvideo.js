  ...
  const options = {
    ...
    try {
      ...
      function generateSlideElement(currentSlide) {
        // Создание элемента <div> с классом 'swiper-slide slider-slide'
        const slideElement = document.createElement('div');
        slideElement.className = 'swiper-slide slider-slide';
    
        // Создание внутренней структуры HTML
    ...
    function generateSlider(params) {
   ...
   // let currentSwiper = document.body.querySelector(`.sliderNumber${second}`)
    ...
    arr.forEach(element => {
      ...
      if(second < genres.length) {
        scrollSliders.insertAdjacentElement('beforeend',slider);   
      };

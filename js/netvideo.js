...
let preloadSliders = document.querySelector('.main__preload-sliders');
let page = 0;
let second = 0;
let isLoading = false;
let genres = ['scifi', 'war%2Cdrama', 'romance%2Ccomedy', 'action', 'thriller', 'animation', 'adventure'];
let genresTitle = ['Scifi', 'War Drama', 'Romance Comedy', 'Action', 'Thriller', 'Animation', 'Adventure'];
